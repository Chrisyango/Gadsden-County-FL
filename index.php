...
<main id="main">
	...
	<section id="counter">
		<div class="container">
			<div class="population-size counter">
				<span class="timer" data-from="0" data-to="46" data-speed="5000" data-refresh-interval="50"></span>
				<h3>population size</h3>
			</div>
			<div class="largest-city counter">
				<span>8th</span>
				<h3>largest county in florida</h3>
			</div>
			<div class="park-land counter">
				<span class="timer" data-from="1" data-to="160" data-speed="5000" data-refresh-interval="50"></span>
				<h3>acres of park land</h3>
			</div>
			<div class="gadsden-businesses counter">
				<span class="timer" data-from="1" data-to="640" data-speed="5000" data-refresh-interval="50"></span>
				<h3>gadsden businesses</h3>
			</div>
		</div><!-- /.container -->
	</section><!-- /#counter -->
